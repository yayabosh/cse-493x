...
import tkinter
import tkinter.font
from chapter1 import request, BOOKMARKS
...
from chapter5 import BLOCK_ELEMENTS, layout_mode, DrawRect
...
class Browser:
    ...
    def handle_click(self, e):
        ...
        if e.y < CHROME_PX:
            ...
            elif 40 <= e.x < WIDTH - 35 and 40 <= e.y < 90:
                self.focus = "address bar"
                self.address_bar = ""
            elif WIDTH - 35 <= e.x < WIDTH - 10 and 40 <= e.y < 90:
    ...
    def draw(self):
        ...
        url = self.tabs[self.active_tab].url
        self.canvas.create_rectangle(40, 50, WIDTH - 40, 90, outline="black", width=1)
        if self.focus == "address bar":
            self.canvas.create_text(
                55,
                55,
        ...
        color = "yellow" if url in BOOKMARKS else "white"
        self.canvas.create_rectangle(
            WIDTH - 35, 50, WIDTH - 10, 90, outline="black", width=1, fill=color
        )
